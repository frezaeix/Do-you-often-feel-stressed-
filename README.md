...
```mermaid
gantt
    title 4-Week Transition Plan
    dateFormat  YYYY-MM-DD
    axisFormat  %b %d
    section Week 1
    Plan schedule & buffer day      :a1, 2026-08-31, 7d
    Begin daily breathing & grounding: a2, after a1, 7d
    section Week 2
    Establish work-study routine     :b1, 2026-09-07, 7d
    Start exercise & consistent sleep: b2, after b1, 7d
    section Week 3
    Refine boundaries/habits         :c1, 2026-09-14, 7d
    Adjust German-study plan         :c2, after c1, 7d
    section Week 4
    Maintain routines & review       :d1, 2026-09-21, 9d
    Plan next cycle & setbacks       :d2, after d1, 7d
```
